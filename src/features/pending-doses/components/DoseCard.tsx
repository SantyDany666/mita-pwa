        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col gap-1 flex-1 min-w-0">
            <div className="flex items-center justify-between gap-2">
              <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-bold bg-orange-100 text-orange-700 dark:bg-orange-900/40 dark:text-orange-300">
                {time}
              </span>
            </div>
    ...
    return (
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col gap-1 flex-1 min-w-0">
            <div className="flex items-center justify-between gap-2">
              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-xs font-semibold bg-gray-100 text-gray-500 dark:bg-gray-800 dark:text-gray-400">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-base font-bold leading-tight truncate line-through decoration-gray-400/50">
              {medicine}
            </p>
          </div>
        </div>
